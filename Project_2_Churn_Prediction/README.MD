...
An interactive Power BI dashboard was developed to explore churn trends dynamically using slicers and filters.
...
│   └── Project_2.ipynb
├── dashboard/
│   └── Project - 2 _ Dashboard.pbix
├── reports/
│   └── Project_2_Churn_Prediction.pdf
└── README.md
...
Vivek Raj
BS in Applied Artificial Intelligence & Data Science
